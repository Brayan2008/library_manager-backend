...
public class EditorialController {
    ...
    public ResponseEntity<EditorialResponse> actualizarEditorial(@PathVariable long id, @RequestBody EditorialRequest editorial) {
        return editorialService.updateEditorial(id,editorial)==null ? ResponseEntity.badRequest().build():ResponseEntity.noContent().build();
    }
    
    @PatchMapping("patch/{id}")
    public ResponseEntity<EditorialResponse> patchEditoril(@PathVariable long id, @RequestBody EditorialRequest editorial) {
        return editorialService.patchEditorial(id,editorial)==null ? ResponseEntity.badRequest().build():ResponseEntity.noContent().build();
    }
